...
import com.censoredsoftware.helper.ConfigFile;
import com.google.common.collect.Maps;
import com.minegusta.mauswashere.MausWasHere;
import com.minegusta.mauswashere.location.MLocation;
import com.minegusta.mauswashere.player.Death;
...
public class DataManager {
    // Data
    public static ConcurrentMap<String, MPlayer> players;
    public static ConcurrentMap<UUID, MLocation> locations;
    ...
    public static void flushData() {
        ...
        // Reload the PLUGIN
        Bukkit.getServer().getPluginManager().disablePlugin(MausWasHere.PLUGIN);
        Bukkit.getServer().getPluginManager().enablePlugin(MausWasHere.PLUGIN);
    }
    ...
    public static enum File {
        PLAYER(new ConfigFile<String, MPlayer>() {
            @Override
            public MPlayer create(String string, ConfigurationSection conf) {
                return new MPlayer(string, conf);
            }

            @Override
            public ConcurrentMap<String, MPlayer> getLoadedData() {
                return DataManager.players;
            }

            @Override
            public String getSavePath() {
                return MausWasHere.SAVE_PATH;
            }
        ...
        }), LOCATION(new ConfigFile<UUID, MLocation>() {
            @Override
            public MLocation create(UUID uuid, ConfigurationSection conf) {
                return new MLocation(uuid, conf);
            }

            @Override
            public ConcurrentMap<UUID, MLocation> getLoadedData() {
